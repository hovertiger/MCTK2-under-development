...
public class SMVValueVarInfo extends SMVVarInfo {
	...
	public SMVValueVarInfo(Boolean visible, String a_name, SMVParsingInfo an_info,
	...
	public SMVAbstractElementInfo clone_element() throws SMVParseException {
		return new SMVValueVarInfo(this.visible, this.name, this.parse_info, this.values);
	}
